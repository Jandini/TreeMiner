namespace TreeMiner.tests
{
    public static class FileSystemTreeMinerExtensions
    {
        ...
        public static IEnumerable<TTreeArtifact> GetArtifacts<TTreeArtifact, TBaseArtifact, TFileArtifact, TDirArtifact>(
            this GenericTreeMiner<TTreeArtifact, TBaseArtifact, TFileArtifact, TDirArtifact> miner, TTreeArtifact dirArtifact,
